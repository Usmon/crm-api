...
final class Controller extends Controllers
{
    ...
    {
        return Json::sendJsonWith200([
            'recipient' => $this->service->showRecipientPhone($this->repository->checkPhone($this->service->getOnlyPhone($request)), $this->service->getOnlyPhone($request)),
        ]);
    }
     ...
     * @return JsonResponse
     */
    public function phoneSearch(RecipientsRequest $request): JsonResponse
    {
        return Json::sendJsonWith200([
    ...
    public function update(RecipientsRequest $request, Recipient $recipient): JsonResponse
    {
        return Json::sendJsonWith200([
            ...
            'recipient' => $this->service->showRecipient($this->repository->updateRecipient($recipient, $this->service->updateCredentials($request))),
        ]);
    }
